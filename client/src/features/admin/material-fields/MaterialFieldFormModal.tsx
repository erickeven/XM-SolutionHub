...
import type { FieldConfigItem, FieldType } from '../../../api/admin-material-fields';
import { useCreateFieldConfig, useUpdateFieldConfig } from '../../../api/admin-material-fields';
...
interface MaterialFieldFormModalProps {
  open: boolean;
  mode: 'create' | 'edit';
...
export function MaterialFieldFormModal({
  open,
  mode,
  field,
  onClose,
}: MaterialFieldFormModalProps) {
      ...
      <Form form={form} layout="vertical" className="mt-4">
        ...
        {isSelectType && (
          ...
          >
            <TextArea
              rows={4}
              placeholder='[{"label":"数据手册","value":"datasheet"}]'
            />
          </Form.Item>
        )}
        <Form.Item
          ...
          help='支持 min/max/minLength/maxLength/pattern，例如 {"maxLength":200}'
        >
          <TextArea rows={3} placeholder='{"maxLength":200}' />
        </Form.Item>
      </Form>
    </Modal>
  );
