...
} from '../../../api/admin-material-fields';
import { MaterialFieldFormModal } from './MaterialFieldFormModal';
...
export function MaterialFieldSettingsPage() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-xl font-bold text-slate-900">资料字段设置</h1>
          <p className="mt-1 text-sm text-slate-500">
            管理资料表单的动态字段配置，标题/类型/状态为内置核心字段不可删除
          </p>
        </div>
